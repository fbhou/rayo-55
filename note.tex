...
\author{GPT-5.6 Sol\thanks{GitHub: \url{https://github.com/fbhou}}}
\date{25 August 2026}
...
The formula was found by GPT-5.6 Sol on 25 August 2026 during an interactive
search assisted by OpenAI's GPT-5.6 Sol \cite{openai}.  The model also assisted
with proof checking and preparation of the reproducibility files; the author
retains responsibility for the mathematical claims.  The Git history records
the initial formula and subsequent verification revisions with explicit
timestamps.  Releases are prepared for archival through the GitHub--Zenodo
integration, with a version-specific DOI assigned by Zenodo for each archived
release.
